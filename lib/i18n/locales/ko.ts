...
const ko: Dict = {
  ...
  home: {
    eyebrow: "B2B · B2G 무역 네트워크",
    heroTitle: "한국 제조사와 해외 바이어를 잇는 신뢰의 다리",
    heroSubtitle:
      "산업재, EPC와 IPP 프로젝트, 소비재까지. 모든 연결은 운영팀이 직접 검토하고 중개해요.",
    browseBoards: "게시판 둘러보기",
    boardsTitle: "게시판 살펴보기",
    valueTitle: "목록이 아니라 신뢰를 쌓는 곳",
    value1Title: "검수 후 게시",
    value1Body: "모든 글과 메시지는 운영팀의 검토를 거친 뒤에만 공개돼요.",
    value2Title: "완전 중개 연결",
    value2Body: "이메일도 전화번호도 노출되지 않아요. 모든 문의는 양방향으로 운영팀이 전달해요.",
    value3Title: "의미 있는 배지",
    value3Body: "제조사·인증 배지는 서류 확인을 거친 뒤에만 부여돼요.",
    featured: "추천 기업",
  ...
  footer: {
    ...
    tagline: "한국 제조사와 해외 바이어를 잇는 신뢰 기반 B2B·B2G 무역 커뮤니티.",
  },
  cookie: {
