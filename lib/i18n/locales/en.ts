const en = {
  common: {
    ...
    operatorTeam: "B2BB2G Operations",
    confirm: "Confirm",
    cancel: "Cancel",
    save: "Save",
    edit: "Edit",
  ...
  search: {
    ...
    heroTitle: "Find the right product, partner or opportunity.",
    heroBody:
      "Search verified marketplace listings in real time. Results update as you type.",
    popular: "Popular searches",
    popularFallback: "Solar, CNC, Beauty, EPC, Generator",
    ...
    recommendedEyebrow: "Recommended for buyers",
    recommendedTitle: "Verified picks",
    recommendedBody:
      "Start with products and project capabilities published by members with visible trust credentials.",
    latestEyebrow: "Recently added",
    latestTitle: "Latest products",
    latestBody:
      "Explore the newest products and supply capabilities added to the marketplace.",
    bannerEyebrow: "B2BB2G buyer desk",
    bannerTitle: "Still looking for the right fit?",
    bannerBody:
      "Review live sourcing requests or use B2BB2G services to move a specific requirement forward.",
    bannerPrimary: "View sourcing requests",
    bannerSecondary: "Explore business services",
  ...
  auth: {
    ...
    consentCookies: "Cookie Policy",
    consentMarketing: "Marketing messages (email / SMS)",
    consentView: "View",
    consentNeeded: "Please agree to the required items.",
    ...
    invitationOneUseNote: "This is a single-use invitation just for you — it expires automatically once you finish signing up.",
  ...
  dashboard: {
    ...
    referralInfoExpires: "It expires automatically once they sign up or the expiry date passes, and cannot be reused or reshared.",
    referralInfoRecopy: "You can re-copy any active link anytime from the list below — no rush.",
    invitationRecipient: "Recipient note (optional)",
    invitationRecipientPlaceholder: "e.g. Kim at ABC Corp",
    createInvitation: "Create invitation",
    invitationGenerated: "New invitation link created — copy it below and send.",
    invitationExpires: "Expires",
    invitationNoLabel: "No note",
    invitationStatusWaiting: "Waiting",
    invitationStatusSigningUp: "Signing up",
    ...
    invitationExpiresInDays: "Expires in {n} days",
    invitationExpiresToday: "Expires today",
    invitationExpiresTomorrow: "Expires tomorrow",
    invitationRevokeConfirmTitle: "Cancel this invitation?",
    invitationRevokeConfirmBody:
      "This link will no longer work for signing up, and this cannot be undone.",
    invitationRevokeConfirmYes: "Revoke invitation",
  ...
  admin: {
    ...
    settingLabels: {
      search_popular_en: "Popular searches (English, comma-separated)",
      search_popular_ko: "Popular searches (Korean, comma-separated)",
      ...
      legal_policy_effective_date: "Legal policy effective date",
      legal_policy_version: "Legal policy version",
      legal_operator_name: "Legal service operator",
      legal_privacy_department: "Privacy department",
      legal_contact_path: "Privacy and legal request path",
    ...
    overview: "Overview",
    opsQueueTitle: "Operations at a glance",
    opsQueueHint:
      "The longest-waiting items in each queue. Posts open their detail page, where you can approve, hold, or edit in place.",
    opsQueueEmpty: "Nothing waiting.",
    opsViewAll: "View all",
    postControlsTitle: "Admin tools",
    postControlsApprove: "Approve",
    postControlsHold: "Hold",
    postControlsEdit: "Edit",
    postControlsDelete: "Delete",
    postControlsDeleteTitle: "Delete this post?",
    postControlsDeleteBody:
      "The post and all of its images and attachments will be removed permanently.",
    postControlsQueue: "Review queue",
    ...
    trendsTitle: "Activity trends",
    hotkeyHint: "J/K move · A approve · R reject",
    timeline: "Activity timeline",
    tlPost: "Post",
    tlInquirySent: "Inquiry sent",
    tlInquiryReceived: "Inquiry received",
    tlFeed: "Network post",
    tlBadge: "Badge application",
    tlLogin: "Signed in",
    daysUnit: "d",
    trendSignups: "New members",
    trendPosts: "New posts",
    trendInquiries: "New inquiries",
    trendRecentWeek: "Last 7 days",
    ...
    groupOperations: "Content & alerts",
    groupOperationsDesc: "Publish notices and content, and set notification policy.",
    ...
    noErrorLogs: "No errors recorded.",
    ...
    moveDown: "Move down",
    groupHome: "Home",
    groupHomeDesc: "See operations status and today's to-dos at a glance.",
    quickAccess: "Quick access",
    quickAccessHint: "Pick a category to jump to what you want to manage.",
    groupReview: "Review & approve",
    groupReviewDesc: "Review and approve member posts, messages, and badges.",
    groupMembers: "Members & membership",
    groupMembersDesc: "Manage member records, referrals, invitations, and membership.",
    groupCatalog: "Boards & catalog",
    groupCatalogDesc: "Set up menus, categories, and member tiers.",
    groupSystem: "System & security",
    groupSystemDesc: "Site settings, security, audit log, and staff access.",
    intro: {
      moderation: "Review member products and posts, then approve or return them. Start with the pending queue.",
      feed: "Review reports on the member social feed and hide or restore posts.",
      inquiries: "Review member inquiry messages and forward or return them.",
      coordinatorMessages: "Review messages exchanged between coordinators and members.",
      badges: "Approve or return member badge applications and manage badge types.",
      members: "Search members, view details, change status, and export.",
      referrals: "See who referred whom as a tree and grant coordinator access.",
      invitations: "Manage the use and expiry of issued signup invite links.",
      subscriptions: "Manage member membership status and expiry.",
      menus: "Add, order, and configure top menus and boards.",
      catalog: "Manage product categories and input fields.",
      tiers: "Set member tiers and per-tier permissions.",
      content: "Write and publish content such as notices.",
      notifications: "Manage notification and email delivery policy and failures.",
      security: "Review sign-in security, risky logins, and device policy.",
      settings: "Change site-wide default settings.",
      audit: "Review the admin action history (audit log).",
      team: "Manage admin staff and their permissions.",
      landing: "Edit the main landing page's hero image and every section's copy. Leave a field blank to use the default.",
    },
    landingEditor: "Landing page",
    landing: {
      title: "Landing page editor",
      blankHint:
        "Leave a field blank to use its default copy. Upload the hero background image below.",
      saved: "Saved.",
      heroImage: "Hero background image",
      heroImageHint:
        "Image shown behind the main hero. JPG, PNG, WebP or AVIF, up to 10MB.",
      noImage: "No image set",
      uploadImage: "Upload image",
      imageError: "Could not upload the image. Check the format and size.",
      featuredSlots: "Featured products count",
      langKo: "KO",
      langEn: "EN",
      roles: {
        eyebrow: "Eyebrow",
      ...
      sections: {
        hero: "Hero",
        newProducts: "New products",
        howItWorks: "How it works & values",
        requests: "Latest requests",
        showcase: "Featured & events",
        feed: "Social feed",
        rails: "Category rails",
        finalCta: "Final CTA",
      },
    },
  ...
  notifications: {
    ...
    feedLiked: "New like on your post",
    ...
    marketingBody: "Get offers and news by email / SMS. You can turn this off anytime.",
    marketingOn: "On",
    marketingOff: "Off",
    ...
    pushLater: "Later",
    pushCategories: "Notification types",
    pushCatPosts: "Post reviews",
    pushCatMessages: "Inquiry messages",
    pushCatBadges: "Badges",
    pushCatSocial: "Likes and comments",
    pushCatMembership: "Membership",
  ...
  toast: {
    ...
    closed: "Closed.",
    approved: "Approved.",
    held: "The post is now on hold and back in the review queue.",
